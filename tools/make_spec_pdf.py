...
# ParseException, и строка в PDF НЕ ПОПАДАЛА ВОВСЕ — молча. Измерено: из 22 строк с
# долларом до PDF доходило 12. Документ записи терял ровно те места, где норматив
# цитирует код, — и терял их тихо, оставляя правдоподобный PDF.
